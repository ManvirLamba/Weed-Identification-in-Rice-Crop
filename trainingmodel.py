...
Original file is located at
    https://colab.research.google.com/drive/16go89YM690_ZpZJCekRFjndOoFAdoBuc
"""
...
img = cv.imread('IMG_20220907_125655.jpg')# read images
cv2_imshow(img)
Z = img.reshape((-1,3))
Z = np.float32(Z)
print(Z)
...
fig, ax = plt.subplots(10,2, sharey=True) # Define subplots
dis = []
...
for i in range(10):
  ...
  ax[i, 1].imshow(res2[:,:,0],cmap='CMRmap')
  ax[i,1].set_title('K = %s Image'%K)
  ax[i, 0].imshow(img)
  ax[i,0].set_title('Original Image')
  dis = np.append(dis,ret)
